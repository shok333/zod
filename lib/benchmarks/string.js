...
var optionalStringSchema = index_1.z.string().optional();
var optionalNullableStringSchema = index_1.z.string().optional().nullable();
suite
    ...
    .add("optional string", function () {
    optionalStringSchema.parse(long);
})
    .add("nullable string", function () {
    optionalNullableStringSchema.parse(long);
})
    .add("nullable (null) string", function () {
